 ...
 * This file demonstrates how to integrate Orbitloom with a web frontend
 */

// For React/Vue/Angular applications
export class OrbitloomClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new OrbitloomClient(provider, contractAddress);
